#!/usr/bin/env node
/**
 * Site X-Ray v37 — Universal precision cloner.
 * Builds on v36 with PIXEL-FOCUS improvements:
 *   - Scroll-triggered video autoplay: add autoplay to videos with scroll-trigger data attrs
 *   - Font preloading: inject preload hints for local font files for faster font rendering
 *   - Font-display: swap in captured @font-face rules to prevent FOIT
 *   - Previous: image dimension preservation, image visibility, early viewport capture
 *
 * Single file. One dependency (playwright). Zero config.
 *
 * Usage: node v37-stable.js <url> [output-dir] [max-pages] [flags]
