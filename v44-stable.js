#!/usr/bin/env node
/**
 * Site X-Ray v44 — Universal precision cloner.
 * Builds on v43 with METRIC-FOCUS improvement:
 *   - Bake computed transforms before DOM capture to preserve animation frame state
 *   - Previous: freeze CSS transitions, animation freeze, early viewport screenshot
 *
 * Single file. One dependency (playwright). Zero config.
 *
 * Usage: node v44-stable.js <url> [output-dir] [max-pages] [flags]
