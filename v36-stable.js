#!/usr/bin/env node
/**
 * Site X-Ray v36 — Universal precision cloner.
 * Builds on v35 with UNIVERSAL improvements:
 *   - Image dimension preservation: inline width/height on all imgs before capture
 *   - Image visibility: force hidden carousel/slider images to remain in layout flow
 *   - Previous: screenshot timeout safety, early viewport capture, relative links, text capture
 *
