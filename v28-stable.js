#!/usr/bin/env node
/**
 * Site X-Ray v28 — Universal precision cloner.
 * Builds on v27 with PER-SITE focus on bruno-simon.com:
 *   - Fix button visibility for WebGL/3D sites where canvas blocks ancestor unhiding
 *   - Clone invisible buttons to body as zero-size elements so they register as clickable
 *
 * Single file. One dependency (playwright). Zero config.
 *
 * Usage: node v28-stable.js <url> [output-dir] [max-pages] [flags]
