#!/usr/bin/env node
/**
 * Site X-Ray v29 — Universal precision cloner.
 * Builds on v28 with PER-SITE focus on bruno-simon.com:
 *   - Fix canvas→image replacement in post-processing (canvas-0.png captured but not referenced)
 *   - Capture canvas parent background colors for WebGL/3D sites
 *   - Ensure body background matches original for canvas-heavy pages
 *
