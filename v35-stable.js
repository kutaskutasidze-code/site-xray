#!/usr/bin/env node
/**
 * Site X-Ray v35 — Universal precision cloner.
 * Builds on v34 with METRIC-FOCUS on pixel fidelity:
 *   - Screenshot timeout safety on early viewport capture (prevents hang on font-heavy sites)
 *   - Previous: early viewport capture, relative link handling, text capture
 *
...
if (!TARGET) {
  console.log(`Site X-Ray v35
Usage: node v35-stable.js <url> [output-dir] [max-pages] [flags]
