#!/usr/bin/env node
/**
 * Site X-Ray v10 — Multi-page website cloner + WebGL/3D extractor
 * Merges X-Ray v7 (full page clone + animations) with Sneaky Rat (WebGL shaders + 3D models).
 * Single file. One dependency (playwright). Zero config.
 *
 * Usage: node v10-stable.js <url> [output-dir] [max-pages]
...
if (!TARGET) { console.log('Site X-Ray v10\nUsage: node v10-stable.js <url> [output-dir] [max-pages]'); process.exit(0); }
